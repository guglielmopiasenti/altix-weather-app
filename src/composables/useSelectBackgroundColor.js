    ...
    switch (condition.toLowerCase()) {
      ...
      case "scattered clouds":
        backgroundColorClass =
           ...
           "bg-gradient-to-r from-gray-50/400 to-sky-400/40  backdrop-filter backdrop-blur-sm";
        break;
      case "broken clouds":
      ...
      case "shower drizzle":
         backgroundColorClass =
           "bg-gradient-to-r from-partly-gray-500/40 to-gray-400-light  backdrop-filter backdrop-blur-sm";
        break;
      case "freezing rain":
        backgroundColorClass =
          "bg-gradient-to-r from-gray-500/40 to-gray-400/40  backdrop-filter backdrop-blur-sm";
